...
<div class="ps_featuredproducts products-carousel oh" data-num="{$products|count}" data-prefix="pr{$unique_id}">
  <h4 class="module-title"><span>Polecamy</span></h4>
  ...
  <a class="hidden" href="{$allProductsLink}">{l s='All products' d='Modules.Featuredproducts.Shop'}</a>
</div>
