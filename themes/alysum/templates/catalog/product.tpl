...
{block name='content'}
  ...
  <section id="main" itemscope itemtype="https://schema.org/Product">
    ...
    <div class="row product-page-col page-width">
      <div class="col-md-6 zdjecia_produktu">
        ...
        <div class="col-md-6 product-info-section">
          ...
          <!-- Sekcja funkcje -->
          <div>
                    <section class="product-features funkcje_produktow">
                      <dl class="data-sheet">
                        {foreach from=$product.features item=feature}
                        {if ({$feature.name}=="Kamień" or {$feature.name}=="Kolor złota" or {$feature.name}=="Próba")}
                        <div class="funkcje">
                ...
                <form action="{$urls.pages.cart}" method="post" id="add-to-cart-or-refresh">
                  ...
                  {if $category->id_category==17}
                    <p><span class="rozmiar_gratis">Nie znalazłeś rozmiaru? Zrobimy go dla Ciebie gratis!</span></p>
                      <p><span class="rozmiar_gratis opakowanie_gratis">Do każdego zamówienia otrzymasz eleganckie opakowanie gratis.</span></p>
                  {/if}
      ...
      <!-- Sekcja funkcje -->
          <div>
                    <section class="product-features funkcje_produktow">
                      ...
                      <dl class="data-sheet">
                      <div class = "funkcje">
                          <dt class="name">{l s='Wzór nr' d='Shop.Theme.Catalog'}:</dt>
                          <dd class="value">{$product.reference_to_display}</dd>
                      </div>
                      <div class = "funkcje">
                         <!-- <dt class="name">Potrzebujesz inny rozmiar? Napisz do nas. Dopasujemy go dla Ciebie bezpłatnie.</dt>-->
                      </div>
                        {foreach from=$product.features item=feature}
