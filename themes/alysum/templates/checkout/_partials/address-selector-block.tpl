  ...
  >
    ...
    <footer class="address-footer">
      {if $interactive}
        ...
        >
          <svg class="svgic"><use xlink:href="#si-pencil"></use></svg> {l s='Edit' d='Shop.Theme.Actions'}
        </a>
        <a
        ...
        >
          <svg class="svgic"><use xlink:href="#si-cross"></use></svg> {l s='Delete' d='Shop.Theme.Actions'}
        </a>
      {/if}
    </footer>
  </article>
