 ...
 *}
<section id="js-checkout-summary" class="card js-cart cart-detailed-totals" data-refresh-url="{$urls.pages.cart}?ajax=1">
    ...
    {block name='cart_summary_products'}
      <div class="cart-summary-products">
        ...
        <header class="flex-container mini-cart-header">
          ...
          <a href="#" data-toggle="collapse" class="show-cart-details collapsed" data-target="#cart-summary-product-list">
            {l s='Show Details' d='Shop.Theme'}
