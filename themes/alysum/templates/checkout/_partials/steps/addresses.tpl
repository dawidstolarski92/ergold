  ...
  <div class="js-address-form">
    ...
    >
      ...
      {elseif $customer.addresses|count > 0}
        ...
        <p class="add-address">
          <a href="{$new_address_delivery_url}"><svg class="svgic"><use xlink:href="#si-add"></use></svg>{l s='Add new address' d='Shop.Theme.Actions'}</a>
        </p>
      ...
      {if !$use_same_address}
        ...
        {else}
          ...
          <p class="add-address">
            <a href="{$new_address_invoice_url}"><svg class="svgic"><use xlink:href="#si-add"></use></svg>{l s='Add new address' d='Shop.Theme.Actions'}</a>
          </p>
        {/if}
