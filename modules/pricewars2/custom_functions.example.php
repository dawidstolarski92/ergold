...
/**
	Funkcja przyjmuje jako parametr obiekt z informacjami o produkcie. Tutaj można go modyfikować
	Tablicę należy zwrócić, jeśli nie zostanie zwrócona , będzie błąd. Zwrócienie false (===) spowoduje pominięcie produktu przy eksporcie.
*/
 ...
 * @return void
 */
function pricewars2_product(\pricewars2\product $product, $id_xml, $id_lang, $service){
