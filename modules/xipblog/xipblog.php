...
class xipblog extends Module implements WidgetInterface
{
	...
	public $all_hooks = array("displayHeader","ModuleRoutes","displayHome","content_top","content_bottom");
	...
	public function __construct()
	{
		...
		parent::__construct();	
		$this->displayName = $this->l('Xpert Blog');
		$this->description = $this->l('XipBlog Powerfull Prestashop Blog Module');
	...
	public function hookdisplayHome($params) {
        ...
        if ($status == true) {
            $this->smarty->assign($this->getWidgetVariables($params['hook'], array()));
