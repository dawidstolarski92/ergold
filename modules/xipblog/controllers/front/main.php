...
class xipblogMainModuleFrontController extends ModuleFrontController
{
	...
	{
		$themename = xipblog::GetThemeName();
		//print_r(_PS_THEME_DIR_.'modules/'.xipblog::$ModuleName.'/views/templates/front/'.$themename.'/'.$template);
	    if (Tools::file_exists_cache(_PS_THEME_DIR_.'modules/'.xipblog::$ModuleName.'/views/templates/front/'.$themename.'/'.$template)) {
	    	//echo "1"._PS_THEME_DIR_.'modules/'.xipblog::$ModuleName.'/views/templates/front/'.$themename.'/'.$template;
	    	...
	    	//echo "3"._PS_MODULE_DIR_.xipblog::$ModuleName.'/views/templates/front/'.$themename.'/'.$template;
			...
			//echo "4"._PS_MODULE_DIR_.xipblog::$ModuleName.'/views/templates/front/'.$template;
	        return _PS_MODULE_DIR_.xipblog::$ModuleName.'/views/templates/front/'.$template;
	    }
	    //echo $themename.'/'.$template.'|';
	    return false;
	}
