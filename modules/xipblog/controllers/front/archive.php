...
class xipblogArchiveModuleFrontController extends xipblogMainModuleFrontController
{
    ...
    public function initContent()
	{
        ...
        //$template = "/vhosts/prestashop.loc/www/prestashop_1711/modules/xipblog/views/templates/front/default/archive.tpl";
        //echo $template;
        $pre = "module:xipblog/views/templates/front/default/";
        $pre = '';
        $this->setTemplate($pre.$template);
    }
