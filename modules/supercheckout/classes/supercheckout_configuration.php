    ...
    public function getDefaultSettings()
    {
        $settings = array(
            ...
            'customer_subscription' => array(
                'newsletter' => array(
                    'id' => 'newsletter',
                    'title' => 'Dołącz do naszej listy newsletterowej',
                    'sort_order' => 3,
                ...
                'optin' => array(
                    'id' => 'optin',
                    'sort_order' => 4,
                    'title' => 'Chcę otrzymawać informacje o promocjach i specjalnych ofertach',
                    'guest' => array('checked' => 0, 'display' => 1)
                )
            ),
            ...
            'shipping_address' => array(
                ...
                'alias' => array(
                    'id' => 'alias',
                    'title' => 'Indetyfikator adresu w książce adresowej',
                    'sort_order' => 14,
                    'conditional' => 0,
                    'guest' => array('require' => 1, 'display' => 1),
                    'logged' => array('require' => 1, 'display' => 1)
